...
bool update_full_deposit(bool var)
{
  ...
  {
    if (
       (adc_data[0] < 250 && adc_data[0] > 180) ||
       (adc_data[0] < 320 && adc_data[0] > 250) ||
       (adc_data[0] < 490 && adc_data[0] > 450) ||
       (adc_data[0] < 550 && adc_data[0] > 490) ||
       (adc_data[0] < 655 && adc_data[0] > 630) ||
       (adc_data[0] < 680 && adc_data[0] > 655) ||
       (adc_data[0] < 743 && adc_data[0] > 725) ||
       (adc_data[0] > 743)
       )
    {
      return true;
