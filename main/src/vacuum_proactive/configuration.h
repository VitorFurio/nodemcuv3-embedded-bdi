...
public:
  AgentSettings()
  {
    ...
    Statement stm_1_body_1(0);
    BodyInstruction inst_1_1(BodyType::GOAL, stm_1_body_1, EventOperator::GOAL_ACHIEVE);
    ...
    Statement stm_3_body_0(0);
    BodyInstruction inst_0_3(BodyType::GOAL, stm_3_body_0, EventOperator::GOAL_ACHIEVE);
    body_3->add_instruction(inst_0_3);

    Plan plan_3(EventOperator::GOAL_DELETION, stm_3, context_3, body_3);
