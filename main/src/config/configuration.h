...
public:
  AgentSettings()
  {
    ...
    intention_base = new IntentionBase(4, 1);
    ...
    Statement stm_0_dirty(1);
    ContextCondition cond_0_0(stm_0_dirty);
    context_0->add_context(cond_0_0);

    Statement stm_0_body_0(6);
    BodyInstruction inst_0_0(BodyType::ACTION, stm_0_body_0, action_suck);
    body_0->add_instruction(inst_0_0);

    Statement stm_0_body_1(7);
    BodyInstruction inst_1_0(BodyType::ACTION, stm_0_body_1, action_right);
    ...
    BodyInstruction inst_1_1(BodyType::ACTION, stm_1_body_1, action_down);
    ...
    Statement stm_2_body_1(9);
    BodyInstruction inst_1_2(BodyType::ACTION, stm_2_body_1, action_up);
    ...
    Statement stm_3_body_0(6);
    BodyInstruction inst_0_3(BodyType::ACTION, stm_3_body_0, action_suck);
    body_3->add_instruction(inst_0_3);

    Statement stm_3_body_1(10);
    BodyInstruction inst_1_3(BodyType::ACTION, stm_3_body_1, action_left);
