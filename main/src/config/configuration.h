...
public:
  AgentSettings()
  {
    ...
    Belief belief_start(6, update_start, false);
    belief_base->add_belief(belief_start);
    ...
    Statement stm_1_start(6);
    ContextCondition cond_1_1(stm_1_start);
    ...
    Statement stm_5_start(6);
    ContextCondition cond_5_1(stm_5_start);
